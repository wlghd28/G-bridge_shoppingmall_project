...
let htmlstream='';
    ...
    if (body.uid == '' || body.pw1 == '') {
       ...
       db.query('INSERT INTO u26_users (userid, password, username, phonenum, address, point) VALUES (?, ?, ?, ?, ?, ?)', [body.userid, body.pw1, body.username, body.phonenum, body.address, 0], (error, results, fields) => {
          if (error) {
            console.log(error);
...
const HandleLogin = (req, res) => {
  ...
  let htmlstream = '';
      ...
      if (body.uid == '' || body.pass == '') {
       ...
       sql_str = "SELECT userid, password, username from u26_users where userid ='"+ body.uid +"' and password='" + body.pass + "';";
